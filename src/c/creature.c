...
// depending on how far I get there might also be negative sideffects if you reach too far beyond the optimum (stalled for now)
...
bool is_alive(Creature *c) {
    return c->health >= DEFAULT_STAT*0.12; 
}
